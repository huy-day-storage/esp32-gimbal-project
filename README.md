...
Chào mừng bạn đến với dự án Gimbal 2 trục sử dụng vi điều khiển **ESP32** và cảm biến **ICM20602**. Dự án này được thiết kế để ổn định camera/điện thoại một cách mượt mà và nhanh chóng bằng thuật toán tối ưu.
